                        ...
                        <div className="col-xxl-2 col-lg-3 col-sm-4 col-6" key={flower.id}>
                            <div className="product-card px-8 py-16 border border-gray-100 hover-border-main-600 rounded-16 position-relative transition-2">
                                ...
                                <Link to="/product-details" className="product-card__thumb flex-center">
                                    <img src={flower.image || "assets/images/thumbs/product-img6.png"} alt={flower.name} />
                                </Link>
                                <div className="product-card__content mt-12">
                                    ...
                                    <div className="flex-align gap-6">
                                        <span className="text-xs fw-bold text-gray-600">{flower.rating}</span>
                                        <span className="text-15 fw-bold text-warning-600 d-flex">
                                            <i className="ph-fill ph-star" />
                                        </span>
                                        <span className="text-xs fw-bold text-gray-600">({flower.reviews})</span>
                                    </div>
                                    ...
                                    <div className="flex-align gap-4">
                                        ...
                                        <span className="text-gray-500 text-xs">By {flower.store}</span>
                                    </div>
                                    <div className="mt-12">
                                        <div
